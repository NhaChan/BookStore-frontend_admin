<template>
    <div class="container">
        <h3 class="text-center text-primary fw-bold">Cập thông tin nhà xuất bản</h3>
...
<script>
import ProductForm from "@/components/publisher/PublisherForm.vue";
import BookService from "@/services/publish.service";
export default {
    components: {
        ProductForm,
    },
